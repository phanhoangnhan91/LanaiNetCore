...
@Component({
    selector: 'loading',
    styles: [`@-webkit-keyframes uil-default-anim {
                0% {
                    opacity: 1;
                }
